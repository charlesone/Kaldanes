...
template <std::size_t maxStringSize, std::size_t maxPmnkSize>
class Symbiont
{
private:
    ...
    static const std::size_t switchoverPmnkSize = 32;
    ...
    // Try to make the string + null fit in an integer (4-byte) package, struct round-off by the compiler
    ...
    // have an empty tail: hence the optimalMaxPmnkSize.
...
public:
    ...
    void dropAnchorKInit(Symbiont symbArr[], std::size_t size) // parameter size should be (array, array count)
    {
